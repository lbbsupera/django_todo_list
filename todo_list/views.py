...
def home(request):
    return render(request, 'home.html', {'user': "lbbsupera"})
def contact(request):
    return render(request, 'contact-us.html', {'user': "lbbsupera"})
def listings(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            context = {'all_items': all_items, "user":"lbbsupera"}
         ...
         return render(request, 'listings.html', context)
def about(request):
    my_name = "Lloyd Benjamin Bola Supera"
